...
const QuizzQuestionManager = require('./QuizzQuestionManager')
const QuizzResultManager = require('./QuizzResultManager')
...
models.quizz_question = new QuizzQuestionManager()
models.quizz_question.setDatabase(pool)
models.quizz_result = new QuizzResultManager()
models.quizz_result.setDatabase(pool)
